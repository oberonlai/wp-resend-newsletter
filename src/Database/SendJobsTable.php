<?php
/**
 * Send jobs custom table (Broadcast-oriented).
 *
...
/**
 * Manages `{prefix}wprn_send_jobs` via dbDelta.
 *
 * Tracks segment sync + Broadcast create/send progress — not per-recipient
 * transactional batch chunks.
 */
class SendJobsTable {
	 ...
	 */
	public const TABLE_NAME = 'wprn_send_jobs';

	/**
	 * Option storing installed schema version.
	 */
	public const VERSION_OPTION = 'wprn_send_jobs_db_version';
